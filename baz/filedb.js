...
define(["require", "exports", "./async", "./guid"], function (require, exports, async, g) {
    ...
    var FileDb = (function () {
        ...
        FileDb.prototype._initDb = function (db) {
            ...
            fileNodeStore.createIndex(FileDb._FILE_STORE_NAME_INDEX, FileDb._FILE_STORE_NAME_INDEX, { unique: false });
        ...
        FileDb.prototype._getTransaction = function (db, config) {
            ...
            return function (cb) {
                ...
                transaction.onerror = function (ev) {
                    ...
                    config.cb({ success: false, error: ev.target.error });
                };
                ...
                transaction.oncomplete = function (ev) {
                    ...
                    config.cb({ success: true, result: ev.target.result });
                };
                cb(transaction);
            };
        };
        FileDb.prototype._addChildReferenceFor = function (file, transaction) {
            var _this = this;
            async.newTask(function (cb) { return transaction
                ...
                return function (cb) { return transaction
                    .objectStore(FileDb._FILE_NODE_STORE)
        ...
        FileDb.prototype._traverseWithAction = function (transaction, root, action) {
            var _this = this;
            root.forEachChild(function (c) { return transaction
                .objectStore(FileDb._FILE_NODE_STORE)
                .get(FileUtils.getAbsolutePath({
                name: c.name,
        ...
        FileDb.prototype._cpFileNodeBranch = function (source, destination, transaction, detachContent) {
            var _this = this;
            if (detachContent === void 0) { detachContent = false; }
            return function (cb) { return transaction
                .objectStore(FileDb._FILE_NODE_STORE)
                .get(source)
                .onsuccess = function (ev) {
                ...
                _this._traverseWithAction(transaction, root, function (fileNode) {
                    var newNode = null, newNodeData = null, isRoot = fileNode.absolutePath === root.absolutePath, newPathInfo = isRoot
                    ...
                    transaction
                        ...
                        .onsuccess = function (ev) { return cb(fileNode, newNode, transaction); };
                });
            }; };
        };
            ...
            async
                ...
                request.onsuccess = function (ev) {
                    if (typeof (request.result) === 'undefined') {
                        ...
                        cb({ success: false, error: ['No file found at path "', absolutePath, '" in database "', _this.name, '".'].join('') });
                    }
                    else {
        ...
        FileDb.prototype.getFileContent = function (identifier, cb) {
            ...
            async
                .newTask(this._openDb())
                .next(function (db) { return _this._getTransaction(db, transactionConfig); })
                .next(function (transaction) { return _this._resolveContentId(transaction, identifier); })
        ...
        FileDb.prototype.rm = function (absolutePath, cb) {
            ...
            async
                ...
                return function (cb) { return _this._traverseWithAction(transaction, root, function (fileNode) { return transaction
                    .objectStore(FileDb._FILE_NODE_STORE)
                    .delete(fileNode.absolutePath)
                    .onsuccess = function (ev) { return cb(fileNode, transaction); }; }); };
            })
                .next(function (fileNode, transaction) {
                return function (cb) { return transaction
                    .objectStore(FileDb._FILE_CONTENT_STORE)
                    .delete(fileNode.contentId.value)
                    .onsuccess = function (ev) { return cb(fileNode); }; };
            })
        ...
        FileDb.prototype.cp = function (source, destination, cb) {
            ...
            async
                .newTask(this._openDb())
                .next(function (db) { return _this._getTransaction(db, transactionConfig); })
                .next(function (transaction) { return _this._cpFileNodeBranch(source, destination, transaction, true); })
                .next(function (sourceNode, destinationNode, transaction) {
                return function (cb) { return transaction
                    .objectStore(FileDb._FILE_CONTENT_STORE)
                    .get(sourceNode.contentId.value)
                    .onsuccess = function (ev) { return cb(sourceNode, destinationNode, ev.target.result, transaction); }; };
            })
                .next(function (sourceNode, destinationNode, content, transaction) {
                return function (cb) { return transaction
                    .objectStore(FileDb._FILE_CONTENT_STORE)
                    .add(content, destinationNode.contentId.value)
                    .onsuccess = function (ev) { return cb(sourceNode, destinationNode); }; };
            })
        ...
        FileDb.prototype.mv = function (source, destination, cb) {
            ...
            async
                ...
                .next(function (sourceNode, destinationNode, transaction) { return function (cb) {
                return transaction
                    .objectStore(FileDb._FILE_NODE_STORE)
        ...
        FileDb._DEFAULT_ENV = { log: function (any) {
                var args = [];
